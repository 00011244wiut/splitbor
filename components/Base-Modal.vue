		...
		<HeadlessTransitionRoot as="template" :show="open">
			...
			>
				...
				<div class="fixed inset-0 z-50 w-full overflow-y-auto">
					<div
						class="flex justify-center pt-4 mt-10 text-center sm:items-center sm:p-0"
					>
						<HeadlessTransitionChild
							as="template"
							enter="ease-out duration-300"
						...
						>
							<HeadlessDialogPanel
								class="relative z-50 p-4 text-left w-[700px] transition-all transform bg-white rounded-lg"
								:class="[
