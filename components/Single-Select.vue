...
<template>
	<div class="relative" ref="singleSelect">
		...
		<div
			@click="show = !show"
			class="flex items-center justify-between px-3 py-3 rounded-md shadow-sm font-body border"
		...
		>
			...
			<div
				v-if="show"
				class="absolute right-0 flex items-center pr-3 hover:cursor-pointer"
			>
				<Icon name="tabler:chevron-up" color="gray" class="text-xl" />
			</div>
			<div v-else class="absolute right-0 flex items-center pr-3">
